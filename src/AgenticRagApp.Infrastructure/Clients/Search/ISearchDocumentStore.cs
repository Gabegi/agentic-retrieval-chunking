...
public interface ISearchDocumentStore
{
    ...
    // counts; callers that need per-document detail should check the SDK response
    // themselves via a lower-level call — this is the generic path everything else uses.
