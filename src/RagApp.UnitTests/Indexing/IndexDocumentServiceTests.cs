...
public class IndexDocumentServiceTests
{
    ...
    public async Task UpsertDocumentsAsync_CountsSucceededAndFailedFromResponse()
    {
        ...
        var (succeeded, failed) = await service.UpsertDocumentsAsync([new ProtocolsIndexer.Models.ProtocolDocument { Id = "c1" }, new ProtocolsIndexer.Models.ProtocolDocument { Id = "c2" }]);
